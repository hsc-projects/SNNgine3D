...
from vispy.scene import AxisWidget, ColorBarWidget, Label, PanZoomCamera, visuals, Widget
...
class CustomLinkedAxisWidget(AxisWidget):
...
class BasePlotWidget(Widget):
    ...
    def __init__(self,
        ...
        if title is not None:
            self.title = Label(title, color=title_color)
