...
from snngine3d.engine.windows.ui_elements.scenes import (
    CanvasConfig,
    SingleNeuronPlotCanvas
)
...
class MultiModelNeuronStateTensor:
    pass
...
class CurrentControlFrame(SubCollapsibleFrame):
    ...
    def __init__(self, parent, model: SignalModel, window: QMainWindow, fixed_width=300):
...
class SingleNeuronPlotCollapsible(CollapsibleWidget):
    ...
    def __init__(self, parent, app, network, interface: NeuronInterface, title='plot'):
        ...
        plot_frame = self.canvas.frame(parent=self)
...
class SingleNeuronCollapsible(CollapsibleWidget):
    ...
    def set_current_control_widget(self, interface: NeuronInterface, window: QMainWindow):
...
class SingleNeuronCollapsibleContainer:
    ...
    def add_interfaced_neuron(self, network: SpikingNeuralNetwork, app,
                              ...
                              neuron_id: Optional[int] = None, preset=None,
